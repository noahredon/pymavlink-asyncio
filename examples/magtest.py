...
async def main():
    ...
    await mav1.wait_heartbeat()
    await mav2.wait_heartbeat()
    ...
    await mav1.recv_match(type='SYS_STATUS', condition='SYS_STATUS.mode==2 and SYS_STATUS.nav_mode==4', blocking=True)
    await mav2.recv_match(type='SYS_STATUS', condition='SYS_STATUS.mode==2 and SYS_STATUS.nav_mode==4', blocking=True)
    ...
    await mav1.recv_match(type='ACTION_ACK')
    await mav2.recv_match(type='ACTION_ACK')
